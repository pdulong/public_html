...
{
    private $_hc_height; // height of the console (pixels)
     ...
     * HTML page.
     */
    function Debug_HackerConsole_Main($height, $autoAttach=false)
    {
        $this->_hc_height = $height;
     ...
     */
    static function expandTabs($text, $tabSize=4)
    {
    ...
    static function expandTabs_callback($m)
    {
